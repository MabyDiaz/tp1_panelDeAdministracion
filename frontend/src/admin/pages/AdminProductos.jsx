...
//       // Solo agregar si seleccionó archivo
...
//         await axios.put(`/productos/${selectedProducto.id}`, data, {
//           headers: { 'Content-Type': 'multipart/form-data' },
//         });
...
//             <tr>
//               <th className='bg-[#e8e9ea] px-0.5 py-1 text-left text-xs font-medium text-gray-700 uppercase'>
//                 ID
//               </th>
//               <th className='bg-[#e8e9ea] px-0.5 py-1 text-left text-xs font-medium text-gray-700 uppercase max-w-[80px] truncate overflow-hidden'>
//                 Nombre
//               </th>
//               <th className='bg-[#e8e9ea] px-0.5 py-1 text-left text-xs font-medium text-gray-700 uppercase max-w-[180px] truncate overflow-hidden'>
//                 Descripción
//               </th>
//               <th className='bg-[#e8e9ea] px-0.5 py-1 text-left text-xs font-medium text-gray-700 uppercase'>
//                 Precio
...
//                 Categoría
//               </th>
//               <th className='bg-[#e8e9ea] px-0.5 py-1 text-center text-xs font-medium text-gray-700 uppercase'>
//                 Acciones
//               </th>
//             </tr>
//           </thead>
...
//                     <img
//                       src={
//                         prod.imagen instanceof File
//                           ? URL.createObjectURL(prod.imagen)
